...
支持的导入目标：
  ...
  - MAP_BNU_REAL:   北京师范大学校园
  - MAP_SCENIC_REAL: 天坛公园
  - MAP_CAMPUS_OSM:  清华大学校园（学校 OSM 模板，供其他学校复用）
  - MAP_SCENIC_OSM:  颐和园（景区 OSM 模板，供其他景区复用）
...
IMPORT_CONFIGS = {
    ...
    "MAP_BNU_REAL": {
        "name": "北京师范大学 OSM 矢量校园内部图",
        "type": "campus",
        "destination_id": "DEST_007",
        "destination_name": "北京师范大学",
        "bbox": {
            "lat_min": 39.9570, "lat_max": 39.9690,
            "lng_min": 116.3600, "lng_max": 116.3720,
        },
        "default_zoom": 17,
        "supported_transports": ["walk", "bike"],
        "highway_types": ["footway", "path", "pedestrian", "service",
        ...
        "ideal_speed_bike": 220,
        "ideal_speed_sightseeing_car": None,
        "node_prefix": "NODE_BNU_OSM",
        "edge_prefix": "EDGE_BNU_OSM",
        "semantic_pois": [
            {"id": "POI_BNU_001", "name": "北师大南门", "type": "gate",
             "lat": 39.9590, "lng": 116.3668},
            {"id": "POI_BNU_002", "name": "北师大北门", "type": "gate",
             "lat": 39.9675, "lng": 116.3665},
            {"id": "POI_BNU_003", "name": "北师大东门", "type": "gate",
             "lat": 39.9628, "lng": 116.3710},
            {"id": "POI_BNU_004", "name": "北师大西门", "type": "gate",
             "lat": 39.9628, "lng": 116.3610},
            {"id": "POI_BNU_005", "name": "图书馆", "type": "building",
             "lat": 39.9630, "lng": 116.3660},
            {"id": "POI_BNU_006", "name": "教七楼(主楼)", "type": "building",
             "lat": 39.9635, "lng": 116.3675},
            {"id": "POI_BNU_007", "name": "教二楼", "type": "building",
             "lat": 39.9615, "lng": 116.3670},
            {"id": "POI_BNU_008", "name": "体育馆", "type": "building",
             "lat": 39.9605, "lng": 116.3650},
            {"id": "POI_BNU_009", "name": "操场", "type": "scenic_spot",
             "lat": 39.9610, "lng": 116.3640},
            {"id": "POI_BNU_010", "name": "学五食堂", "type": "building",
             "lat": 39.9618, "lng": 116.3655},
            {"id": "POI_BNU_011", "name": "学生宿舍区", "type": "building",
             "lat": 39.9600, "lng": 116.3675},
            {"id": "POI_BNU_012", "name": "科技楼", "type": "building",
             "lat": 39.9640, "lng": 116.3645},
            {"id": "POI_BNU_013", "name": "英东楼", "type": "building",
             "lat": 39.9620, "lng": 116.3680},
        ],
        "facilities": [
            {"id": "FAC_BNU_OSM_001", "name": "图书馆咖啡厅", "category": "cafe",
             "poi_id": "POI_BNU_005", "description": "图书馆一楼咖啡厅"},
            {"id": "FAC_BNU_OSM_002", "name": "主楼洗手间(1F)", "category": "toilet",
             "poi_id": "POI_BNU_006", "description": "教七楼一层公共洗手间"},
            {"id": "FAC_BNU_OSM_003", "name": "教二楼洗手间(1F)", "category": "toilet",
             "poi_id": "POI_BNU_007", "description": "教二楼一层洗手间"},
            {"id": "FAC_BNU_OSM_004", "name": "学五食堂", "category": "canteen",
             "poi_id": "POI_BNU_010", "description": "学生食堂"},
            {"id": "FAC_BNU_OSM_005", "name": "校园超市", "category": "supermarket",
             "poi_id": "POI_BNU_011", "description": "学生宿舍区便利店"},
            {"id": "FAC_BNU_OSM_006", "name": "图书馆", "category": "library",
             "poi_id": "POI_BNU_005", "description": "北京师范大学图书馆"},
            {"id": "FAC_BNU_OSM_007", "name": "体育场洗手间", "category": "toilet",
             "poi_id": "POI_BNU_009", "description": "操场旁公共洗手间"},
            {"id": "FAC_BNU_OSM_008", "name": "南门服务点", "category": "service_desk",
             "poi_id": "POI_BNU_001", "description": "南门访客登记处"},
            {"id": "FAC_BNU_OSM_009", "name": "东门服务点", "category": "service_desk",
             "poi_id": "POI_BNU_003", "description": "东门访客登记处"},
            {"id": "FAC_BNU_OSM_010", "name": "体育馆服务台", "category": "service_desk",
             "poi_id": "POI_BNU_008", "description": "体育馆前台"},
            {"id": "FAC_BNU_OSM_011", "name": "教二楼咖啡点", "category": "cafe",
             "poi_id": "POI_BNU_007", "description": "教二楼自动咖啡机"},
            {"id": "FAC_BNU_OSM_012", "name": "食堂洗手间", "category": "toilet",
             "poi_id": "POI_BNU_010", "description": "食堂旁洗手间"},
            {"id": "FAC_BNU_OSM_013", "name": "科技楼超市", "category": "shop",
             "poi_id": "POI_BNU_012", "description": "科技楼小卖部"},
            {"id": "FAC_BNU_OSM_014", "name": "英东楼洗手间", "category": "toilet",
             "poi_id": "POI_BNU_013", "description": "英东楼洗手间"},
            {"id": "FAC_BNU_OSM_015", "name": "西门快递站", "category": "service_desk",
             "poi_id": "POI_BNU_004", "description": "西门快递收发点"},
        ],
    },
    "MAP_CAMPUS_OSM": {
        "name": "清华大学 OSM 矢量校园内部图（学校模板）",
        "type": "campus",
        "destination_id": None,
        "destination_name": None,
        "bbox": {
            "lat_min": 39.9900, "lat_max": 40.0100,
            "lng_min": 116.3100, "lng_max": 116.3400,
        },
        "default_zoom": 16,
        "supported_transports": ["walk", "bike"],
        "highway_types": ["footway", "path", "pedestrian", "service",
        ...
        "ideal_speed_bike": 220,
        "ideal_speed_sightseeing_car": None,
        "node_prefix": "NODE_THU_OSM",
        "edge_prefix": "EDGE_THU_OSM",
        "semantic_pois": [
            {"id": "POI_THU_001", "name": "清华西门", "type": "gate",
             "lat": 39.9970, "lng": 116.3150},
            {"id": "POI_THU_002", "name": "清华南门", "type": "gate",
             "lat": 39.9930, "lng": 116.3260},
            {"id": "POI_THU_003", "name": "清华东门(主校门)", "type": "gate",
             "lat": 40.0000, "lng": 116.3380},
            {"id": "POI_THU_004", "name": "清华北门", "type": "gate",
             "lat": 40.0075, "lng": 116.3260},
            {"id": "POI_THU_005", "name": "图书馆(逸夫馆)", "type": "building",
             "lat": 39.9995, "lng": 116.3220},
            {"id": "POI_THU_006", "name": "大礼堂", "type": "building",
             "lat": 39.9980, "lng": 116.3205},
            {"id": "POI_THU_007", "name": "清华学堂", "type": "building",
             "lat": 39.9990, "lng": 116.3210},
            {"id": "POI_THU_008", "name": "主楼", "type": "building",
             "lat": 40.0005, "lng": 116.3365},
            {"id": "POI_THU_009", "name": "综合体育馆", "type": "building",
             "lat": 39.9965, "lng": 116.3320},
            {"id": "POI_THU_010", "name": "东大操场", "type": "scenic_spot",
             "lat": 39.9970, "lng": 116.3310},
            {"id": "POI_THU_011", "name": "观畴园(万人食堂)", "type": "building",
             "lat": 40.0030, "lng": 116.3250},
            {"id": "POI_THU_012", "name": "紫荆园食堂", "type": "building",
             "lat": 40.0050, "lng": 116.3270},
            {"id": "POI_THU_013", "name": "学生公寓区", "type": "building",
             "lat": 40.0060, "lng": 116.3290},
            {"id": "POI_THU_014", "name": "美术学院", "type": "building",
             "lat": 40.0000, "lng": 116.3170},
            {"id": "POI_THU_015", "name": "近春园(荷塘)", "type": "scenic_spot",
             "lat": 39.9960, "lng": 116.3185},
        ],
        "facilities": [
            {"id": "FAC_THU_OSM_001", "name": "图书馆咖啡厅", "category": "cafe",
             "poi_id": "POI_THU_005", "description": "逸夫馆一楼咖啡厅"},
            {"id": "FAC_THU_OSM_002", "name": "大礼堂洗手间", "category": "toilet",
             "poi_id": "POI_THU_006", "description": "大礼堂公共洗手间"},
            {"id": "FAC_THU_OSM_003", "name": "观畴园食堂", "category": "canteen",
             "poi_id": "POI_THU_011", "description": "万人食堂"},
            {"id": "FAC_THU_OSM_004", "name": "紫荆园食堂", "category": "canteen",
             "poi_id": "POI_THU_012", "description": "紫荆园学生食堂"},
            {"id": "FAC_THU_OSM_005", "name": "学生区超市", "category": "supermarket",
             "poi_id": "POI_THU_013", "description": "学生公寓区便利店"},
            {"id": "FAC_THU_OSM_006", "name": "图书馆", "category": "library",
             "poi_id": "POI_THU_005", "description": "清华大学图书馆"},
            {"id": "FAC_THU_OSM_007", "name": "操场洗手间", "category": "toilet",
             "poi_id": "POI_THU_010", "description": "东大操场旁洗手间"},
            {"id": "FAC_THU_OSM_008", "name": "西门服务点", "category": "service_desk",
             "poi_id": "POI_THU_001", "description": "西门访客登记处"},
            {"id": "FAC_THU_OSM_009", "name": "东门服务点", "category": "service_desk",
             "poi_id": "POI_THU_003", "description": "主校门访客服务中心"},
            {"id": "FAC_THU_OSM_010", "name": "综合体育馆服务台", "category": "service_desk",
             "poi_id": "POI_THU_009", "description": "体育馆前台"},
            {"id": "FAC_THU_OSM_011", "name": "清华学堂咖啡", "category": "cafe",
             "poi_id": "POI_THU_007", "description": "清华学堂咖啡角"},
            {"id": "FAC_THU_OSM_012", "name": "食堂洗手间", "category": "toilet",
             "poi_id": "POI_THU_011", "description": "观畴园旁洗手间"},
            {"id": "FAC_THU_OSM_013", "name": "美术学院超市", "category": "shop",
             "poi_id": "POI_THU_014", "description": "美术学院小卖部"},
            {"id": "FAC_THU_OSM_014", "name": "近春园洗手间", "category": "toilet",
             "poi_id": "POI_THU_015", "description": "荷塘附近洗手间"},
            {"id": "FAC_THU_OSM_015", "name": "南门快递站", "category": "service_desk",
             "poi_id": "POI_THU_002", "description": "南门快递收发点"},
        ],
    },
    "MAP_SCENIC_OSM": {
        "name": "颐和园 OSM 矢量内部图（景区模板）",
        "type": "attraction",
        "destination_id": None,
        "destination_name": None,
        "bbox": {
            "lat_min": 39.9880, "lat_max": 40.0080,
            "lng_min": 116.2600, "lng_max": 116.2850,
        },
        "default_zoom": 16,
        "supported_transports": ["walk", "sightseeing_car"],
        "highway_types": ["footway", "path", "pedestrian", "steps"],
        ...
        "ideal_speed_bike": None,
        "ideal_speed_sightseeing_car": 300,
        "node_prefix": "NODE_YHY_OSM",
        "edge_prefix": "EDGE_YHY_OSM",
        "semantic_pois": [
            {"id": "POI_YHY_001", "name": "东宫门(正门)", "type": "gate",
             "lat": 39.9985, "lng": 116.2810},
            {"id": "POI_YHY_002", "name": "北宫门", "type": "gate",
             "lat": 40.0055, "lng": 116.2755},
            {"id": "POI_YHY_003", "name": "新建宫门", "type": "gate",
             "lat": 39.9935, "lng": 116.2710},
            {"id": "POI_YHY_004", "name": "南如意门", "type": "gate",
             "lat": 39.9895, "lng": 116.2680},
            {"id": "POI_YHY_005", "name": "西门", "type": "gate",
             "lat": 39.9970, "lng": 116.2615},
            {"id": "POI_YHY_006", "name": "万寿山", "type": "scenic_spot",
             "lat": 40.0010, "lng": 116.2755},
            {"id": "POI_YHY_007", "name": "佛香阁", "type": "scenic_spot",
             "lat": 40.0015, "lng": 116.2760},
            {"id": "POI_YHY_008", "name": "十七孔桥", "type": "scenic_spot",
             "lat": 39.9960, "lng": 116.2785},
            {"id": "POI_YHY_009", "name": "长廊", "type": "scenic_spot",
             "lat": 40.0000, "lng": 116.2760},
            {"id": "POI_YHY_010", "name": "石舫", "type": "scenic_spot",
             "lat": 40.0030, "lng": 116.2740},
            {"id": "POI_YHY_011", "name": "苏州街", "type": "scenic_spot",
             "lat": 40.0060, "lng": 116.2770},
            {"id": "POI_YHY_012", "name": "德和园", "type": "scenic_spot",
             "lat": 39.9990, "lng": 116.2790},
            {"id": "POI_YHY_013", "name": "昆明湖", "type": "scenic_spot",
             "lat": 39.9950, "lng": 116.2740},
            {"id": "POI_YHY_014", "name": "游客服务中心", "type": "building",
             "lat": 39.9980, "lng": 116.2815},
        ],
        "facilities": [
            {"id": "FAC_YHY_OSM_001", "name": "游客服务中心", "category": "service_desk",
             "poi_id": "POI_YHY_014", "description": "旅游咨询、导览图、轮椅租赁"},
            {"id": "FAC_YHY_OSM_002", "name": "东宫门洗手间", "category": "toilet",
             "poi_id": "POI_YHY_001", "description": "东宫门附近公共洗手间"},
            {"id": "FAC_YHY_OSM_003", "name": "北宫门洗手间", "category": "toilet",
             "poi_id": "POI_YHY_002", "description": "北宫门附近公共洗手间"},
            {"id": "FAC_YHY_OSM_004", "name": "新建宫门洗手间", "category": "toilet",
             "poi_id": "POI_YHY_003", "description": "新建宫门附近洗手间"},
            {"id": "FAC_YHY_OSM_005", "name": "佛香阁洗手间", "category": "toilet",
             "poi_id": "POI_YHY_007", "description": "佛香阁附近洗手间"},
            {"id": "FAC_YHY_OSM_006", "name": "长廊文创商店", "category": "shop",
             "poi_id": "POI_YHY_009", "description": "颐和园主题文创纪念品"},
            {"id": "FAC_YHY_OSM_007", "name": "石舫咖啡点", "category": "cafe",
             "poi_id": "POI_YHY_010", "description": "景区自动咖啡售卖"},
            {"id": "FAC_YHY_OSM_008", "name": "东宫门售票处", "category": "ticket",
             "poi_id": "POI_YHY_001", "description": "东宫门入口售票处"},
            {"id": "FAC_YHY_OSM_009", "name": "北宫门售票处", "category": "ticket",
             "poi_id": "POI_YHY_002", "description": "北宫门入口售票处"},
            {"id": "FAC_YHY_OSM_010", "name": "苏州街洗手间", "category": "toilet",
             "poi_id": "POI_YHY_011", "description": "苏州街景区洗手间"},
            {"id": "FAC_YHY_OSM_011", "name": "德和园洗手间", "category": "toilet",
             "poi_id": "POI_YHY_012", "description": "德和园附近洗手间"},
            {"id": "FAC_YHY_OSM_012", "name": "南如意门售票处", "category": "ticket",
             "poi_id": "POI_YHY_004", "description": "南如意门售票处"},
            {"id": "FAC_YHY_OSM_013", "name": "十七孔桥休息点", "category": "restaurant",
             "poi_id": "POI_YHY_008", "description": "昆明湖畔休息区"},
            {"id": "FAC_YHY_OSM_014", "name": "游客中心咖啡", "category": "cafe",
             "poi_id": "POI_YHY_014", "description": "游客服务中心咖啡吧"},
            {"id": "FAC_YHY_OSM_015", "name": "西门服务点", "category": "service_desk",
             "poi_id": "POI_YHY_005", "description": "西门游客服务点"},
        ],
    },
}
